...
const FLUJO_BIENVENIDA_MIRO = {
  ...
  // PLAN, DATOS Y ROAMING - DERIVACIÓN AUTOMÁTICA AL CDU PLAN X BOTONERA
  plan_datos_roaming: {
    messages: [
      "📱 **Plan, Datos y Roaming**\n\nTe voy a conectar con nuestro sistema especializado de gestión de planes.\n\n🎯 **Selecciona el perfil del cliente que estás atendiendo:**",
    ],
    options: [
      {
  ...
  // POOL - PLAN, DATOS Y ROAMING MÓVIL - DERIVACIÓN AUTOMÁTICA AL CDU PLAN X BOTONERA
  pool_movil_plan_datos_roaming: {
    messages: [
      "📱 **Plan, Datos y Roaming - Pool Móvil**\n\nTe voy a conectar con nuestro sistema especializado de gestión de planes.\n\n🎯 **Selecciona el perfil del cliente que estás atendiendo:**",
    ],
    options: [
      {
        text: "🏢 TOP EMP - Usuario",
      ...
      { text: "🔙 Volver", action: "pool_linea_movil" },
    ],
  },
