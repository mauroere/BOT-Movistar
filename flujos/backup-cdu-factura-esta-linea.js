...
// Flujo B2C/No cliente: División automática por ANI → Segmentación por Premium/TOP → Derivación según DN  // ✅ OPCIONES DE FACTURACIÓN (para Titular o Usuario con acceso)
  factura_opciones_completas: {
    messages: [
      "🔍 **Analizando segmento y tipo de cliente...**\n\nEl sistema está identificando automáticamente tu perfil..."
    ],
    options: [
      { text: "Premium y Emprendedores - Cliente Móvil", action: "premium_emprendedores_cliente_movil" },
  ...
  factura_b2c_premium_emprendedores: {
    ...
    options: [
      { text: "Consultar otra línea", action: "factura_consultar_otra_linea_cuit" },
      { text: "Menú principal", action: "menu_principal" },
    ],
  },
  ...
  factura_error_linea_inactiva: {
    ...
    options: [
      { text: "Suspensión Total (deuda) - Premium y Emprendedores", action: "suspension_total_premium_emprendedores" },
      { text: "Suspensión Total (deuda) - TOP EMP", action: "suspension_total_top_emp" },
      { text: "Suspensión Otra (robo, fraude, etc) - Premium y Emprendedores", action: "suspension_otra_premium_emprendedores" },
      { text: "Suspensión Otra (robo, fraude, etc) - TOP EMP", action: "suspension_otra_top_emp" },
  ...
  factura_linea_fija_opciones: {
    ...
    options: [
      { text: "Consulta última factura", action: "factura_fija_ultima_factura" },
      { text: "Consulta facturas anteriores", action: "factura_fija_facturas_anteriores" },
      { text: "Reclamo técnico-facturación", action: "factura_fija_reclamo_tecnico" },
  ...
  factura_opciones_genericas: {
    ...
    options: [
      ...
      { text: "Reclamo de facturación", action: "factura_seleccionar_linea_reclamo" },
