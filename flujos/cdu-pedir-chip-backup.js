// CDU Pedir un Chip
// Mensajes exactos del   //=== FLUJO AMBA ===//
  ...
  pedir_chip_amba: {
    ...
    options: [
      { text: "Esta línea", action: "pedir_chip_transferir" },
      { text: "Otra línea del CUIT", action: "pedir_chip_transferir" },
      { text: "3 líneas o más", action: "pedir_chip_tres_lineas" },
    ],
  },
  ...
  pedir_chip_nueva_direccion: {
    ...
    options: [
      ...
      { text: "Te transfiero con un representante", action: "pedir_chip_transferir" },
    ],
  },
